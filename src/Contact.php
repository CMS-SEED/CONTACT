...
class Contact
{
     ...
     * Constructor.
     */
    public function __construct(\Cms_Framework_Seed\Contact\Interfaces\ContactRepositoryInterface $contact)
    {
    ...
    public function gadget($view = 'admin.contact.gadget', $count = 10)
    {
        ...
        if (User::hasRole('user')) {
            $this->contact->pushCriteria(new \Cms_Framework_Seed\Cms_Framework_Seed\Repositories\Criteria\ContactUserCriteria());
        }
