...
namespace Cms_Framework_Seed\Contact\Http\Controllers;

use App\Http\Controllers\ResourceController as BaseController;
use Cms_Framework_Seed\Contact\Http\Requests\ContactRequest;
use Cms_Framework_Seed\Contact\Interfaces\ContactRepositoryInterface;
use Cms_Framework_Seed\Contact\Models\Contact;
...
class ContactResourceController extends BaseController
{
    ...
    public function __construct(ContactRepositoryInterface $contact)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Cms_Framework_Seed\Contact\Repositories\Criteria\ContactResourceCriteria::class);
    }
    ...
    public function index(ContactRequest $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            $data      = $this->repository
                ->setPresenter(\Cms_Framework_Seed\Contact\Repositories\Presenter\ContactListPresenter::class)
        ...
        $this->response->theme->asset()->container('footer')->add('gmap', 'https://maps.googleapis.com/maps/api/js?key=' . config('cms_framework_seed.contact.gmapapi'));
